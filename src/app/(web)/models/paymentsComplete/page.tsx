    ...
    <main>
      ...
      <div className="h-[calc(100vh-420px)] bg-black text-white p-4 flex flex-col items-center justify-center gap-y-[40px]">
        <div className="flex flex-col">
          <h1 className="text-[60px] text-center text-white border-b-[1px] border-white">
            {title || ''}{' '}
          </h1>
        ...
        <button className="btnBasic border-[white] px-[40px] py-[15px] mt-[40px] hover:bg-white hover:text-black">
          홈으로 돌아가기
        </button>
      </div>
    </main>

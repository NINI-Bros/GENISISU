          ...
          <table className="border-collapse w-full table-fixed">
            ...
            <tbody className="border-t border-solid border-black">
              {places.map((place, idx) => 
                <tr key={place.name + idx} className="border-b border-solid border-ccc max-[1366px]:mb-10 max-[1366px]:justify-items-center">
                  <th className="w-full p-4 whitespace-nowrap font-medium bg-gray-100">{place.name}</th>
                  <td className="p-4 whitespace-nowrap font-light max-[1366px]:whitespace-normal max-[1366px]:break-keep max-[1366px]:text-center">{place.address}</td>
                  <td className="p-4 whitespace-nowrap font-light max-[1366px]:py-1">{place.telephone}</td>
              </tr>
              )}
            </tbody>
          </table>

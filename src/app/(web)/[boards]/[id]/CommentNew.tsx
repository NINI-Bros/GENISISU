    ...
    <div className="py-4 border-gray-200 mb-40">
      <form>
        ...
        <textarea
          ...
          cols={40}
          maxLength={1000}
          className={`block ${isWarningMargin(errors.content)} p-2 w-full text-sm border border-gray-300 bg-gray-50 focus:outline-gray-400 focus:ring-2 focus:ring-blue-200 dark:bg-gray-200 dark:placeholder-gray-400 dark:text-black resize-none`}
